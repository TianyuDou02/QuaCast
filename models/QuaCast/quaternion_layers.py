...
class QuaternionTransposeConv(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 ...
                 weight_init='quaternion', seed=42, operation='convolution2d', rotation=False,
...
class QuaternionConv(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 ...
                 weight_init='quaternion', seed=42, operation='convolution2d', rotation=False, quaternion_format=True, scale=False):

        super(QuaternionConv, self).__init__()

        self.in_channels       = in_channels  // 4 //groups
        self.out_channels      = out_channels // 4
        self.stride            = stride
        self.padding           = padding
        self.groups            = groups
...
class QuaternionLinearAutograd(Module):
    ...
    def __init__(self, in_features, out_features, bias=True,
                 ...
                 seed=42, rotation=False, quaternion_format=True, scale=False):
