...
if __name__ == '__main__':
    ...
    train = SEVIRTorchDataset(dataset_dir='/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/sevir',
                              )
    print("train:",len(train))
    test = SEVIRTorchDataset(dataset_dir='/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/sevir',
                             start_date=datetime.datetime(*train_valid_split),
                            end_date=datetime.datetime(*valid_test_split),
                             )
    print("test:",len(test))
    val = SEVIRTorchDataset(dataset_dir='/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/sevir',
