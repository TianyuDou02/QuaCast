...
DATAPATH = {
    ...
    'shanghai' : 'path/to/dataset/data/shanghai.h5',
    'meteo' : 'path/to/dataset/data/meteo_radar.h5',
    'sevir' : 'path/to/dataset/data/sevir'
}
...
def get_dataset(data_name, img_size, seq_len, **kwargs):
    ...
    if dataset_name == 'cikm':
        ...
        train_valid_split = (2017, 12, 31)
        valid_test_split = (2018, 4, 30)
        test_last_split = (2018, 8, 31)
